{ config, pkgs, lib, ... }:
{
  ...
  environment.interactiveShellInit = ''
    ...
    alias sync='curl -L https://gitlab.com/jorgensen-j/nixos/-/raw/main/rpi3.nix | tee /home/pi/configuration.nix && sudo cp /home/pi/configuration.nix /etc/nixos/configuration.nix'
